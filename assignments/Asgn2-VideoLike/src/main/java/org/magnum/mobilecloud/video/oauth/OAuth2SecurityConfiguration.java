	...
	protected static class OAuth2Config extends
		...
		public OAuth2Config() throws Exception {
			...
			ClientDetailsService csvc = new InMemoryClientDetailsServiceBuilder()
					...
					// video service
					.withClient("mobile2").authorizedGrantTypes("password")
			...
			UserDetailsService svc = new InMemoryUserDetailsManager(
					Arrays.asList(
							User.create("admin", "pass", "ROLE_TRUSTED_CLIENT", "ROLE_CLIENT"),
							User.create("user0", "pass", "ROLE_CLIENT"),
							User.create("user1", "pass", "ROLE_CLIENT"),
							User.create("user2", "pass", "ROLE_CLIENT"),
							User.create("user3", "pass", "ROLE_CLIENT"),
							User.create("user4", "pass", "ROLE_"),
